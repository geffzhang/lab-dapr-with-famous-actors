...
namespace Mod.Dapr.Client
{
    ...
    public class CustomDaprClient : DaprClient
    {
        ...
        public override JsonSerializerOptions JsonSerializerOptions => throw new NotImplementedException();

        // property exposed for testing purposes
        internal Autogenerated.Dapr.DaprClient Client => client;

        internal CustomDaprClient(
            GrpcChannel channel,
            Autogenerated.Dapr.DaprClient inner,
            HttpClient httpClient,
            Uri httpEndpoint,
            IDaprClientSerDes serdes,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var content = ByteString.CopyFrom(_serdes.PublishEventSerialize<TData>(data));
            ...
            CancellationToken cancellationToken)
        {
            ...
            if (content != null)
            {
                ...
                envelope.DataContentType = _serdes.PublishEventContentType;
            }
            ...
            {
                throw new ApplicationException("Publish operation failed: the Dapr endpoint indicated a failure. See InnerException for details.", ex);
            }
        }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var bytes = ByteString.CopyFrom(_serdes.InvokeBindingSerialize<TRequest>(data));
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                return _serdes.InvokeBindingDeserialize<TResponse>(response.Data.Span);
            }
            catch (JsonException ex)
            {
                throw new ApplicationException("Binding operation failed: the response payload could not be deserialized. See InnerException for details.", ex);
            }
        }
           ...
           CancellationToken cancellationToken = default)
        {
            ...
            {
                throw new ApplicationException("Binding operation failed: the Dapr endpoint indicated a failure. See InnerException for details.", ex);
            }
        }
        #endregion
        ...
        public override HttpRequestMessage CreateInvokeMethodRequest<TRequest>(HttpMethod httpMethod, string appId, string methodName, TRequest data)
        {
            ...
            request.Content = _serdes.InvokeMethodSerialize<TRequest>(data);
        ...
        public async override Task<TResponse> InvokeMethodAsync<TResponse>(HttpRequestMessage request, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                return await _serdes.InvokeMethodDeserializeAsync<TResponse>(response.Content, cancellationToken);
            }
            catch (HttpRequestException ex)
            {
                // Our code path for creating requests places these keys in the request properties. We don't want to fail
        ...
        public override async Task<IReadOnlyList<BulkStateItem>> GetBulkStateAsync(string storeName, IReadOnlyList<string> keys, int? parallelism, IReadOnlyDictionary<string, string> metadata = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                throw new ApplicationException("State operation failed: the Dapr endpoint indicated a failure. See InnerException for details.", ex);
            }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                return _serdes.GetStateDeserialize<TValue>(response.Data.Span);
            }
            catch (JsonException ex)
            {
                throw new ApplicationException("State operation failed: the state payload could not be deserialized. See InnerException for details.", ex);
            }
        }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                return (_serdes.GetStateDeserialize<TValue>(response.Data.Span), response.Etag);
            }
            catch (JsonException ex)
            {
                throw new ApplicationException("State operation failed: the state payload could not be deserialized. See InnerException for details.", ex);
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            if (value != null)
            {
                stateItem.Value = ByteString.CopyFrom(_serdes.SaveStateSerialize<TValue>(value));
            }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                throw new ApplicationException("Secret operation failed: the Dapr endpoint indicated a failure. See InnerException for details.", ex);
            }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                throw new ApplicationException("Bulk secret operation failed: the Dapr endpoint indicated a failure. See InnerException for details.", ex);
            }
